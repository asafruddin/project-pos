...
export default function LoyaltyPage() {
  ...
  return (
    <DashboardShell
      ...
      title="Loyalitas"
      subtitle="Aturan poin bersama. Kasir tidak mengubah aturan. Tukar poin hanya saat online; penjualan tetap selesai jika program mati."
    >
      <LoyaltyPanel canEdit={hasPermission(me.permissions, "loyalty", "update")} />
    </DashboardShell>
  );
}
